...
export const Slider = () => {
  ...
  const movingCardSize = 380 * position;
  ...
  return (
    <section className="slider grid">
      <span className='slider__container grid__item--desktop-5-33'>
        <span className="slider__head ">
          ...
          <div className="slider__buttons">
            <button
              ...
              disabled={isFirst}
            >
              <p className='slider__button-image slider__button-image--left'>
            ...
            <button
              ...
              disabled={isLast}
            >
              <p className='slider__button-image slider__button-image--right'>
      ...
      <div className="slider__cards grid__item--desktop-5-36">
